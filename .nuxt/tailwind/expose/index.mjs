...
const config = { theme, corePlugins, plugins, content, safelist, darkMode, prefix, variants, presets, important, separator, blocklist }
export { config as default, theme, corePlugins, plugins, content, safelist, darkMode, prefix, variants, presets, important, separator, blocklist }